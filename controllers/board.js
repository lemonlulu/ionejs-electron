...
//To apply inherits in js
util.inherits(BoardController, Controller);

//In js, methods are implement in Object.prototype.
var p = BoardController.prototype;
...
p.yourMethod = function() {
	//Print something
	console.log("Board Controller receives the Action Event.");
}
...
module.exports.instance = new BoardController()
